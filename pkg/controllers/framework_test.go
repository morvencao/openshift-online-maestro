...
func (d *exampleController) OnAdd(ctx context.Context, source, sourceID string) error {
	d.addCounter++
	return nil
}

func (d *exampleController) OnUpdate(ctx context.Context, source, sourceID string) error {
	d.updateCounter++
	return nil
}

func (d *exampleController) OnDelete(ctx context.Context, source, sourceID string) error {
	d.deleteCounter++
	return nil
}
