...
[**ApiMaestroV1FilesyncersGet**](DefaultAPI.md#ApiMaestroV1FilesyncersGet) | **Get** /api/maestro/v1/filesyncers | Returns a list of filesyncers
[**ApiMaestroV1FilesyncersIdDelete**](DefaultAPI.md#ApiMaestroV1FilesyncersIdDelete) | **Delete** /api/maestro/v1/filesyncers/{id} | Delete a file syncer
[**ApiMaestroV1FilesyncersIdGet**](DefaultAPI.md#ApiMaestroV1FilesyncersIdGet) | **Get** /api/maestro/v1/filesyncers/{id} | Get a file syncer by id
[**ApiMaestroV1FilesyncersIdPatch**](DefaultAPI.md#ApiMaestroV1FilesyncersIdPatch) | **Patch** /api/maestro/v1/filesyncers/{id} | Update a file syncer
[**ApiMaestroV1FilesyncersPost**](DefaultAPI.md#ApiMaestroV1FilesyncersPost) | **Post** /api/maestro/v1/filesyncers | Create a new filesyncer
...
## ApiMaestroV1FilesyncersGet

> FileSyncerList ApiMaestroV1FilesyncersGet(ctx).Page(page).Size(size).Search(search).OrderBy(orderBy).Fields(fields).Execute()

Returns a list of filesyncers
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.ApiMaestroV1FilesyncersGet(context.Background()).Page(page).Size(size).Search(search).OrderBy(orderBy).Fields(fields).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.ApiMaestroV1FilesyncersGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ApiMaestroV1FilesyncersGet`: FileSyncerList
	fmt.Fprintf(os.Stdout, "Response from `DefaultAPI.ApiMaestroV1FilesyncersGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiMaestroV1FilesyncersGetRequest struct via the builder pattern
...
[**FileSyncerList**](FileSyncerList.md)
...
## ApiMaestroV1FilesyncersIdDelete

> ApiMaestroV1FilesyncersIdDelete(ctx, id).Execute()

Delete a file syncer
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.DefaultAPI.ApiMaestroV1FilesyncersIdDelete(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.ApiMaestroV1FilesyncersIdDelete``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiApiMaestroV1FilesyncersIdDeleteRequest struct via the builder pattern
...
## ApiMaestroV1FilesyncersIdGet

> FileSyncer ApiMaestroV1FilesyncersIdGet(ctx, id).Execute()

Get a file syncer by id
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.ApiMaestroV1FilesyncersIdGet(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.ApiMaestroV1FilesyncersIdGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ApiMaestroV1FilesyncersIdGet`: FileSyncer
	fmt.Fprintf(os.Stdout, "Response from `DefaultAPI.ApiMaestroV1FilesyncersIdGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiMaestroV1FilesyncersIdGetRequest struct via the builder pattern
...
## ApiMaestroV1FilesyncersIdPatch

> FileSyncer ApiMaestroV1FilesyncersIdPatch(ctx, id).FileSyncerPatchRequest(fileSyncerPatchRequest).Execute()

Update a file syncer
...
func main() {
	id := "id_example" // string | The id of record
	fileSyncerPatchRequest := *openapiclient.NewFileSyncerPatchRequest() // FileSyncerPatchRequest | Updated file syncer data

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.ApiMaestroV1FilesyncersIdPatch(context.Background(), id).FileSyncerPatchRequest(fileSyncerPatchRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.ApiMaestroV1FilesyncersIdPatch``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ApiMaestroV1FilesyncersIdPatch`: FileSyncer
	fmt.Fprintf(os.Stdout, "Response from `DefaultAPI.ApiMaestroV1FilesyncersIdPatch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiMaestroV1FilesyncersIdPatchRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **fileSyncerPatchRequest** | [**FileSyncerPatchRequest**](FileSyncerPatchRequest.md) | Updated file syncer data | 
...
## ApiMaestroV1FilesyncersPost

> FileSyncer ApiMaestroV1FilesyncersPost(ctx).FileSyncer(fileSyncer).Execute()

Create a new filesyncer
...
func main() {
	fileSyncer := *openapiclient.NewFileSyncer() // FileSyncer | File syncer data

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.ApiMaestroV1FilesyncersPost(context.Background()).FileSyncer(fileSyncer).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.ApiMaestroV1FilesyncersPost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ApiMaestroV1FilesyncersPost`: FileSyncer
	fmt.Fprintf(os.Stdout, "Response from `DefaultAPI.ApiMaestroV1FilesyncersPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiMaestroV1FilesyncersPostRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fileSyncer** | [**FileSyncer**](FileSyncer.md) | File syncer data | 
