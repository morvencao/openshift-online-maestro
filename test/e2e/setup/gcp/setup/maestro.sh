...
# Get redential to access GKE cluster
...
gcloud sql databases create maestro \
    --instance=maestro
echo "Cloud SQL database is created"

# Create DB user
echo "Creating database user for Cloud SQL instance..."
gcloud sql users create maestro \
  --instance=maestro \
  --password=${db_pw}
...
echo "Maestro GSA and KSA are bind"
