...
- Ensue your `gcloud` CLI is logged in with your GCP account and the GCP account should have the permissions to operate PubSub and Cloud SQL in your provided region
...
```sh
export CLUSTER_ID="<your_service_cluster_id>"  # e.g. management
...
```sh
export REGION="<your_gke_cluster_region>"
export CLUSTER_ID="<your_gke_cluster_name_or_id>"
export KUBECONFIG="<your_gke_cluster_kubeconfig>"
